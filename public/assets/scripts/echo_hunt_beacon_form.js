(() => {
  ...
  const mapElement = document.getElementById('echo-hunt-beacon-map');
  const latInput = document.querySelector('[data-echo-beacon-lat]');
  const lonInput = document.querySelector('[data-echo-beacon-lon]');
