(() => {
  ...
  const mapElement = document.getElementById('pandemic-response-hotspot-map');
  const latInput = document.querySelector('[data-pandemic-hotspot-lat]');
  const lonInput = document.querySelector('[data-pandemic-hotspot-lon]');
